...
class Settings implements HookableInterface
{
    ...
    private const ACF_BYPASS_KEY = 'field_69ba7a3ae80fc'; // ACF key for bypass acceptance
    ...
    public function addHooks(): void
    {
        ...
        $this->wpService->addFilter('acf/update_value/key=' . self::ACF_BYPASS_KEY, [$this, 'sanitizeDomainFieldOnSave'], 10, 3);
    }
